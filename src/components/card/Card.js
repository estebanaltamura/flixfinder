...
export const Card = ({ content, URLcontentType, index }) => {
  ...
  const { likeClickHandler, isContentLiked, isLiked } = useLikeHandler();
  ...
  return (
    ...
    >
      <div className="card" style={{ width: "18rem" }} id={`card${index}`}>
        ...
        <div
          className={token ? "cardDetails" : "cardDetails cardDetailsNoLogged"}
        >
          ...
          <div className="shareCardContainer">
            <BsShareFill
              className={
                shareOptionsOpen
                  ? "shareCardIcon shareCardIconActive"
                  : "shareCardIcon"
              }
          ...
          <div
            className={
              shareOptionsOpen
                ? "shareOptionsContainer shareOptionsContainerOpen"
          ...
          {token && (
            <>
              {isLiked ? (
                <FcLike className="cardBodyLike" onClick={likeClick} />
              ) : (
                <FcLikePlaceholder
                  className="cardBodyLike"
                  onClick={likeClick}
                />
              )}
            </>
